...
base_json_path = 'locations_base.json'
transformed_json_path = '../locations.json'

regions = ["Shards", "Skills", "Runes", "Magic Bars", "Coins", "Talismans", "Checkpoints", "Bosses", "Events", "Goals", "Filler"]
json_content = {}
